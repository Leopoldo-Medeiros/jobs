            ...
            <div class="flex flex-col items-center justify-center text-center">
                ...
                <div>
                    ...
                    <div class="text-lg space-y-6">
                        ...
                        <a href="$listing->" target="_blank" class="block bg-black text-white py-2 rounded-xl hover:opacity-80"><i class="fa-solid fa-globe"></i> Visit
                            Website
                        </a>
                    </div>
                </div>
...
{{--                <i class="fa-solid fa-solid fa-pencil"></i>--}}
{{--                Edit--}}
{{--            </a>--}}
